...
- 画像中的 years_of_experience / job_search_status / current_status 影响你的回复策略：
  ...
  - 画像里有 interview_stats → 面试/简历/成长相关对话中自然引用。不要说具体数字（"你的技术深度只有 72 分"），用人话包装：弱项说"可以再磨一磨"、强项说"这块挺稳"、进步了说"一次比一次好"
...
TOOLS = [
    ...
    # ═══ 求职画像 ═══
    {
        ...
        "function": {
            "name": "get_my_profile",
            "description": "查看你的求职画像（教育/技能/经历摘要/项目/目标岗位/目标行业/薪资范围/意向城市/工作年限/求职状态/在职状态/性格备注/面试统计）。"
